...
if (process.platform == 'win32') {
    dir = path.resolve(__dirname, '../', 'rule/test.js');
} else if (process.platform == 'mac' || process.platform == 'darwin') {
    var dir = path.resolve(__dirname, '../', 'rule/test.js');
...
//代理规则
var ruleFile = global.ruleFile = dir || '/Users/wen/wspace/simple-proxy/rule/test.js';
